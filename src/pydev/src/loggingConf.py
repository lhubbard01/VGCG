...
def init_logger():
  ...
  stdout_logging_fmt     = Formatter("%(levelname)s %(asctime)s %(message)s", datefmt="%Y-%m-%dT%H:%M:%sZ")
  stdout_logging_handler.setLevel(INFO)
  stdout_logging_handler.setFormatter(stdout_formatter)
